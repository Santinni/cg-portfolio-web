...
>
export type PublicAuthor = Pick<Author, 'biography' | 'expertise' | 'id' | 'name' | 'role' | 'socialLinks'> & {
...
export const mapPublicAuthor = (author: Author | number | null | undefined): PublicAuthor | null => {
