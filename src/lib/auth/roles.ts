...
export const hasRole = (user: EditorialUser | null, roles: readonly EditorialRole[]): boolean =>
...
export const getRelationshipID = (value: EditorialUser['author']): number | string | null => {
