...
- [x] Decide whether the CV experience timeline and the `/experience` timeline
      ...
      **Decision brief posted on COD-84 (2026-09-11).** Measured finding: the two
      ...
      the one shared candidate (`.sectionHeading`) belongs to COD-82. **Decided
      2026-09-23: CV-only, no refactor** — recorded as CV-11 in
      `docs/decisions/curriculum-vitae.md`; COD-84 closed.
